...
public class GetOperationTest extends IntegrationTest {
    ...
    public void getNonExistedObjectExecuteAsSingle() {
        ...
        TestObserver<TestItem> testtestObserver = new TestObserver<TestItem>();
        testItemSingle.subscribe(testtestObserver);

        testtestObserver.awaitTerminalEvent(5, SECONDS);
        testtestObserver.assertValue(null);
        testtestObserver.assertNoErrors();
