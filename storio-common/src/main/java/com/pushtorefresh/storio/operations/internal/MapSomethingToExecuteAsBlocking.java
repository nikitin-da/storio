 ...
 */
public final class MapSomethingToExecuteAsBlocking<Something, Result> implements Function<Something, Result> {

    @NonNull
    private final PreparedOperation<Result> preparedOperation;

    public MapSomethingToExecuteAsBlocking(@NonNull PreparedOperation<Result> preparedOperation) {
